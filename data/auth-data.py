...
# -----------------------------------------------------------------------------------------------------------------
# Test Case Auth Email Validation Check

positive_email_auth_data = {'111111test111111@protei.ru',  # Email с цифрами в имени аккаунта
...
negative_email_auth_data = {'testprotei.ru',  # Отсутствие @ в email
